...
const
  ...
  {$IF DEFINED(IOS) or DEFINED(ANDROID)}
      URL = 'https://www.blangkon.net/API/APIRadio_v1/APIRadio.php?act=';
      URLImage = 'https://www.blangkon.net/API/APIRadio_v1/files/';
      //URL = 'http://192.168.100.45/appru/API/APIRadio_v1/APIRadio.php?act=';
      //URLImage = 'http://192.168.100.45/appru/API/APIRadio_v1/files/';
  {$ELSE}
      URL = 'https://www.blangkon.net/API/APIRadio_v1/APIRadio.php?act=';
      URLImage = 'https://www.blangkon.net/API/APIRadio_v1/files/';
      //URL = 'http://192.168.100.45/appru/API/APIRadio_v1/APIRadio.php?act=';
...
function fnParseJSON(Cli : TRESTClient; Req : TRESTRequest; Resp :TRESTResponse;
  RespAdapter : TRESTResponseDataSetAdapter; act : String; mem : TFDMemTable; FMethod : TRESTRequestMethod) : Boolean;
var
  i: Integer;
begin
  try
    ...
    req.AddParameter('key', C_KEY, TRESTRequestParameterKind.pkHTTPHEADER);
