...
function fnResizeImage(ABitmap : TBitmap; FResize : Integer) : TBitmap;
function fnResizeImageH(ABitmap : TBitmap; FResize : Integer) : TBitmap;
function fnResizeImageW(ABitmap : TBitmap; FResize : Integer) : TBitmap;
